        ...
        this.container.innerHTML = `
            <div class="page-content">
                ...
                <div style="margin-bottom: 12px;">
                    <input type="search" id="orders-search" placeholder="Поиск по номеру, названию..." autocomplete="off">
                </div>
            ...
            return `
                <div class="card card-outlined ripple order-item" data-id="${order.id}">
                    <div style="display: flex; align-items: flex-start; gap: 12px;">
                        <div style="width: 48px; height: 48px; border-radius: 12px; background: var(--md-tertiary-container); color: var(--md-on-tertiary-container); display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
    ...
    _setupItemListeners() {
        document.querySelectorAll('.order-item').forEach(item => {
            item.addEventListener('click', () => {
                ...
                const order = this.engine.items.find(o => o.id == id);
                if (order) {
