...
export default class PediatricPage {
    constructor(container) {
        ...
        this.data = {
            ...
            reference: {
                ...
                legalReference: null,
                formulas: [
                    { name: 'Оценка веса (1-10 лет)', formula: 'Вес = 3 × возраст + 7', example: '5 лет: 3×5+7 = 22 кг' },
                    { name: 'Оценка веса (10+ лет)', formula: 'Вес = 5 × возраст - 13', example: '12 лет: 5×12-13 = 47 кг' },
                    { name: 'ЭТТ без манжеты', formula: 'ID = 4 + возраст/4', example: '4 года: 4+1 = 5.0 мм' },
                    { name: 'ЭТТ с манжетой', formula: 'ID = 3.5 + возраст/4', example: '4 года: 3.5+1 = 4.5 мм' },
                    { name: 'Глубина интубации', formula: 'Глубина = 3 × ID ЭТТ', example: 'ID 5.0: 3×5 = 15 см' },
                    { name: 'Дефибрилляция', formula: '4 Дж/кг (первый разряд)', example: '20 кг: 80 Дж' }
                ],
                quickRules: [
                    { icon: '💉', rule: 'Адреналин при СЛР: 10 мкг/кг (макс 1 мг)' },
                    { icon: '⚡', rule: 'Дефибрилляция: 4 Дж/кг → 4 Дж/кг → 6 Дж/кг → 8 Дж/кг' },
                    { icon: '💧', rule: 'Болюс при шоке: 10-20 мл/кг NaCl 0.9%' },
                    { icon: '🫁', rule: 'Дыхательный объём: 6-8 мл/кг' },
                    { icon: '⚠️', rule: 'Норадреналин: только через ЦВК!' },
                    { icon: '🌡️', rule: 'Поддерживающая инфузия: правило 4-2-1' }
                ],
                examples: [
                    { scenario: 'Ребёнок 5 лет, 20 кг, ФЖ без пульса', calculation: 'Дефибрилляция: 80 Дж (4 Дж/кг). Адреналин: 0.2 мг (10 мкг/кг). Амиодарон: 100 мг (5 мг/кг)' },
                    { scenario: 'Ребёнок 3 года, 15 кг, шок, нужна вазопрессорная поддержка', calculation: 'Норадреналин: старт 0.1 мкг/кг/мин. Разведение 8 мг в 50 мл = 160 мкг/мл. Скорость: 0.56 мл/ч' },
                    { scenario: 'Ребёнок 7 лет, 25 кг, нужна интубация', calculation: 'ЭТТ с манжетой: 5.0 мм. Глубина: 15 см. Дыхательный объём: 150-200 мл' }
                ]
            },
            drugs: {
                epinephrine: { name: 'Адреналин 0,182% - 1,0 мл', category: 'resuscitation', categoryName: 'Реанимация (СЛР)', icon: 'monitor_heart', ampouleConc: 1, ampouleVol: 1, dilutedConc: 0.1, dilutionDesc: '1 мл + 9 мл NaCl 0.9% = 10 мл (1:10000)', doseMgKg: 0.01, maxDoseMg: 1, route: 'В/в, внутрикостно', repeatInterval: 'Каждые 3–5 мин', warning: 'Макс. 1 мг (вес > 40 кг). Не превышать разовую дозу!', useDiluted: true },
                amiodarone: { name: 'Амиодарон 5% - 3,0 мл', category: 'resuscitation', categoryName: 'Реанимация (СЛР)', icon: 'cardiology', ampouleConc: 50, ampouleVol: 3, doseMgKg: 5, maxDoseMg: 300, route: 'В/в, внутрикостно', dilutionDesc: 'Разводить только в глюкозе 5%', repeatInterval: 'Повторить до макс. 15 мг/кг', warning: 'Риск АВ-блокады! Off-label до 3 лет', useDiluted: false },
                lidocaine: { name: 'Лидокаин 10% - 2,0 мл', category: 'resuscitation', categoryName: 'Реанимация (СЛР)', icon: 'cardiology', ampouleConc: 100, ampouleVol: 2, doseMgKg: 1, maxDoseMg: 100, route: 'В/в струйно', dilutionDesc: 'Альтернатива амиодарону', repeatInterval: 'Титрование 20–50 мкг/кг/мин', warning: 'При ФЖ/ЖТ без пульса', useDiluted: false },
                atropine: { name: 'Атропин 0,1% - 1,0 мл', category: 'resuscitation', categoryName: 'Реанимация (СЛР)', icon: 'heart_broken', ampouleConc: 1, ampouleVol: 1, doseMgKg: 0.02, maxDoseMg: 1, route: 'В/в', repeatInterval: 'Повтор через 5 мин', warning: 'Только при ваготонии, ФОС-отравлениях!', useDiluted: false },
                norepinephrine: { name: 'Норадреналин 0.2% - 4,0 мл', category: 'vasoactive', categoryName: 'Вазоактивные', icon: 'trending_up', ampouleConc: 2, ampouleVol: 4, totalMgPerAmpoule: 8, startDoseMcgKgMin: 0.1, maxDoseMcgKgMin: 0.3, titrationStep: 0.05, route: 'В/в капельно (только ЦВК!)', dilutionDesc: '2 мл + 48 мл глюкозы 5% (шприц)', protocolNote: 'При некупирующейся артериальной гипотензии', warning: 'Только через ЦВК! Титровать до АД > 25-го процентиля', useDiluted: false, specialUnit: 'мкг/кг/мин', specialDose: 0.1, isInfusomat: true },
                prednisolone: { name: 'Преднизолон 3% - 1,0 мл', category: 'vasoactive', categoryName: 'Вазоактивные', icon: 'medication', ampouleConc: 30, ampouleVol: 1, doseMgKg: 2, maxDoseMg: 120, route: 'В/в струйно', dilutionDesc: 'На 10–20 мл NaCl 0.9%', warning: 'Контроль АД после введения', useDiluted: false },
                dexamethasone: { name: 'Дексаметазон 0,4% - 1,0 мл', category: 'vasoactive', categoryName: 'Вазоактивные', icon: 'medication', ampouleConc: 4, ampouleVol: 1, doseMgKg: 0.15, maxDoseMg: 16, route: 'В/в, в/м', dilutionDesc: 'Эквивалент преднизолону 1:7', warning: 'Альтернатива преднизолону', useDiluted: false },
                furosemide: { name: 'Фуросемид 1% - 2,0 мл', category: 'vasoactive', categoryName: 'Вазоактивные', icon: 'water_drop', ampouleConc: 10, ampouleVol: 2, doseMgKg: 1, maxDoseMg: 20, route: 'В/в, в/м медленно', dilutionDesc: 'Дети: 0.5–1.5 мг/кг/сут', repeatInterval: 'Повтор через 20 мин', warning: 'Макс. суточная 20 мг!', useDiluted: false },
                diazepam: { name: 'Диазепам 0.5% - 2,0 мл', category: 'anticonvulsant', categoryName: 'Противосудорожные', icon: 'psychology_alt', ampouleConc: 5, ampouleVol: 2, doseMgKg: 0.3, maxDoseMg: 10, route: 'В/в медленно (3–5 мин)', dilutionDesc: 'Судороги: 0.3–0.4 мг/кг', repeatInterval: 'Повтор через 10 мин', warning: 'Риск апноэ! Макс. 10 мг на дозу', useDiluted: false },
                midazolam: { name: 'Мидазолам 0,5% - 1,0 мл', category: 'anticonvulsant', categoryName: 'Противосудорожные', icon: 'psychology_alt', ampouleConc: 5, ampouleVol: 3, doseMgKg: 0.1, maxDoseMg: 10, route: 'В/в, в/м, ректально', dilutionDesc: 'Ректально: 0.3–0.5 мг/кг', warning: 'Альтернатива диазепаму', useDiluted: false },
                analgin: { name: 'Анальгин 50% - 2,0 мл', category: 'analgesic', categoryName: 'Анальгетики', icon: 'pill', ampouleConc: 500, ampouleVol: 2, doseMgKg: 10, maxDoseMg: 1000, route: 'В/в медленно, в/м', dilutionDesc: '8–16 мг/кг', repeatInterval: 'До 4 раз/сут', warning: '⛔ До 3 мес. не применять!', useDiluted: false },
                tramadol: { name: 'Трамадол 5% - 1,0 мл', category: 'analgesic', categoryName: 'Анальгетики', icon: 'pill', ampouleConc: 50, ampouleVol: 1, doseMgKg: 1.5, maxDoseMg: 100, route: 'В/в, в/м', dilutionDesc: 'Дети 1–14 лет: 1–2 мг/кг', repeatInterval: 'Каждые 4–6 часов', warning: 'Слабый опиоид', useDiluted: false },
                morphine: { name: 'Морфин 1% - 1,0 мл', category: 'analgesic', categoryName: 'Анальгетики', icon: 'pill', ampouleConc: 10, ampouleVol: 1, doseMgKg: 0.1, maxDoseMg: 10, route: 'В/в медленно, п/к', dilutionDesc: 'В/в: 0.05–0.1 мг/кг', repeatInterval: 'Каждые 4–6 часов', warning: '⛔ Не рекомендуется < 1 года!', useDiluted: false },
                dimedrol: { name: 'Димедрол 1% - 1,0 мл', category: 'antihistamine', categoryName: 'Антигистаминные', icon: 'allergies', ampouleConc: 10, ampouleVol: 1, doseMgKg: 0.5, maxDoseMg: 50, route: 'В/м, в/в медленно', dilutionDesc: '7–14 лет: 15–30 мг', repeatInterval: 'Каждые 6–8 часов', warning: 'Макс. суточная 200 мг', useDiluted: false },
                drotaverine: { name: 'Дротаверин 2% - 2,0 мл', category: 'spasmolytic', categoryName: 'Спазмолитики', icon: 'medication', ampouleConc: 20, ampouleVol: 2, doseMgKg: 0.5, maxDoseMg: 80, route: 'В/м, в/в медленно', dilutionDesc: 'Дети: 10–20 мг', repeatInterval: '1–3 раза/сут', warning: 'В/в вводить медленно!', useDiluted: false },
                paracetamol: { name: 'Парацетамол 1,0% - 100,0 мл', category: 'antipyretic', categoryName: 'Жаропонижающие', icon: 'thermometer', ampouleConc: 10, ampouleVol: 100, doseMgKg: 15, maxDoseMg: 1000, route: 'В/в, внутрь, ректально', dilutionDesc: 'Сироп 30 мг/мл', repeatInterval: 'Каждые 4–6 часов', warning: 'Макс. суточная 60 мг/кг', useDiluted: false },
                ibuprofen: { name: 'Ибупрофен (суспензия)', category: 'antipyretic', categoryName: 'Жаропонижающие', icon: 'thermometer', ampouleConc: 20, ampouleVol: 100, doseMgKg: 10, maxDoseMg: 400, route: 'Внутрь', repeatInterval: 'Каждые 6–8 часов', warning: 'С 6 месяцев жизни', useDiluted: false },
                berodual: { name: 'Фенотерол/Ипратропия (Беродуал)', category: 'bronchodilator', categoryName: 'Бронхолитики', icon: 'air', ampouleConc: 0.75, ampouleVol: 2, doseMgKg: 0.015, maxDoseMg: 1, route: 'Ингаляции через небулайзер', dilutionDesc: 'До 6 лет: 0.5 мл', repeatInterval: 'Каждые 20 мин × 3', warning: 'Концентрация: 500 мкг фенотерола + 250 мкг ипратропия/мл', useDiluted: false },
                ceftriaxone: { name: 'Цефтриаксон', category: 'antibiotic', categoryName: 'Антибиотики', icon: 'vaccines', ampouleConc: 100, ampouleVol: 10, doseMgKg: 50, maxDoseMg: 2000, route: 'В/в капельно (30+ мин)', dilutionDesc: 'Развести в воде для инъекций', repeatInterval: '1 раз в сутки', warning: 'При менингите: 100 мг/кг', useDiluted: false },
                cefotaxime: { name: 'Цефотаксим', category: 'antibiotic', categoryName: 'Антибиотики', icon: 'vaccines', ampouleConc: 100, ampouleVol: 10, doseMgKg: 50, maxDoseMg: 2000, route: 'В/в, в/м', dilutionDesc: '4–6 разовых доз в сутки', repeatInterval: 'При менингите — высшие дозы', warning: 'Альтернатива цефтриаксону', useDiluted: false }
            },
            equipment: {
                ettUncuffed: { name: 'ЭТТ без манжеты', icon: 'air', unit: 'мм (ID)' },
                ettCuffed: { name: 'ЭТТ с манжетой', icon: 'air', unit: 'мм (ID)', minCuffPressure: 20, maxCuffPressure: 25 },
                laryngoscope: { name: 'Клинок ларингоскопа', icon: 'visibility', unit: 'размер' },
                mask: { name: 'Маска ИВЛ', icon: 'face', unit: 'размер' },
                gastricTube: { name: 'Зонд для промывания желудка', icon: 'biotech', unit: 'Fr', route: 'Орогастрально' },
    ...
    async render() {
        ...
        await loadCalculatorCSS('pediatric');
                        ...
                        <div class="pediatric-input-group">
                            <div class="pediatric-field-wrapper">
                                ...
                                <input type="number" id="weight-input" class="pediatric-field"
                                    min="${this.limits.weight.min}" max="${this.limits.weight.max}" step="0.1" inputmode="decimal">
                        ...
                        <div class="pediatric-input-group">
                            <div class="pediatric-field-wrapper">
                                ...
                                <input type="number" id="height-input" class="pediatric-field"
                                    min="${this.limits.height.min}" max="${this.limits.height.max}" step="0.5" inputmode="decimal">
                        ...
                        <div class="pediatric-input-group">
                            <div class="pediatric-field-wrapper">
                                ...
                                <input type="number" id="age-input" class="pediatric-field"
                                    min="${this.limits.age.min}" max="${this.limits.age.max}" step="0.1" inputmode="decimal">
    ...
    renderResults() {
        ...
        if (estimatedWeight <= 10) maintenanceMlH = estimatedWeight * 4;
        else if (estimatedWeight <= 20) maintenanceMlH = 40 + (estimatedWeight - 10) * 2;
        else maintenanceMlH = 60 + (estimatedWeight - 20) * 1;

        return `
            <div class="pediatric-summary-header" 
                style="background: linear-gradient(135deg, ${zone.color}20 0%, ${zone.color}40 100%);"
                ...
                <div class="pediatric-summary-grid">
                    ...
                    <div class="summary-column norms-column">
                        ...
                        <div class="summary-row">
                            ...
                            <span class="summary-value">${norms ? `${norms.sbp.min}–${norms.sbp.max} / ${norms.dbp.min}–${norms.dbp.max}` : '—'}</span>
                        </div>
                        <div class="summary-row">
                            <span class="summary-label">ЧСС:</span>
                            <span class="summary-value">${norms ? `${norms.hr.min}–${norms.hr.max} уд/мин` : '—'}</span>
                        </div>
                        <div class="summary-row">
                            <span class="summary-label">ЧД:</span>
                            <span class="summary-value">${norms ? `${norms.rr.min}–${norms.rr.max} /мин` : '—'}</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    renderDrug(drugId, weight) {
        ...
        const specialInfo = drug.specialUnit
            ? `<div class="drug-detail"><span class="drug-label">Дозировка:</span><span class="drug-value">${drug.specialDose} ${drug.specialUnit}</span></div>`
            : `<div class="drug-detail"><span class="drug-label">Дозировка:</span><span class="drug-value">${drug.doseMgKg} мг/кг</span></div>`;

        const limitedNote = isAdultDose
            ? `<div class="drug-detail limited"><span class="drug-label">Расчётная доза:</span><span class="drug-value">${Math.round(calculatedDoseMg)} мг → ограничена</span></div>`
            : '';
            ...
            <div class="pediatric-drug-card norepinephrine-card">
                ...
                <div class="ne-dilution-section">
                    ...
                    <div class="ne-dilution-options">
                        ${[20, 50, 100].map(vol => `
                            <button class="ne-dilution-btn ${this.norepinephrineDilution === vol ? 'active' : ''}" data-dilution="${vol}">
                                ${vol} мл
                            </button>
                        `).join('')}
                    </div>
                ...
                <div class="ne-speed-section">
                    <div class="ne-speed-title">Стартовая скорость (${startDose} мкг/кг/мин):</div>
        ...
        return `
            ...
            <div class="defib-timeline">
                ...
                <div class="defib-step cpr">
                    <div class="defib-step-num"><span class="material-symbols-rounded" style="font-size: 14px;">favorite</span></div>
                    <div class="defib-step-content">
        ...
        switch (equipId) {
            ...
            case 'laryngoscope': {
                if (weight === null || weight === undefined || isNaN(weight)) {
                    ...
                    if (weight < 3) { value = '0'; details = 'Прямой (Miller) · < 3 кг'; }
                    else if (weight < 5) { value = '0'; details = 'Прямой (Miller) · 3–5 кг'; }
                    else if (weight < 10) { value = '1'; details = 'Прямой (Miller) · 5–10 кг'; }
                    else if (weight < 20) { value = '2'; details = 'Прямой/Изогнутый · 10–20 кг'; }
                    else if (weight < 40) { value = '2'; details = 'Изогнутый (Macintosh) · 20–40 кг'; }
            ...
            case 'mask': {
                if (weight === null || weight === undefined || isNaN(weight)) {
                    ...
                    if (weight < 3) { value = '0'; details = 'Новорождённый · < 3 кг'; }
                    else if (weight < 5) { value = '1'; details = 'Младенец · 3–5 кг'; }
                    else if (weight < 10) { value = '2'; details = 'Ребёнок · 5–10 кг'; }
                    else if (weight < 20) { value = '3'; details = 'Ребёнок · 10–20 кг'; }
                    else if (weight < 40) { value = '4'; details = 'Подросток · 20–40 кг'; }
            ...
            case 'gastricTube': {
                ...
                if (volumePerPortion > maxVolume) volumePerPortion = maxVolume;
    ...
    estimateWeightByAge(ageYears) {
        if (ageYears <= 1) return 3 + ageYears * 12 * 0.5;
        else if (ageYears <= 10) return 3 * ageYears + 7;
        else return 3 * ageYears + 7 + (ageYears - 10) * 2;
    }

    estimateWeightByHeight(heightCm) {
        if (heightCm < 100) return (heightCm - 50) * 0.3;
        else return (heightCm - 100) * 0.9;
    }
    ...
    getEffectiveAge() {
        ...
        if (this.weightKg !== null) {
            ...
            else if (w <= 37) return Math.max(1, (w - 7) / 3);
            else return Math.min(18, (w + 13) / 5);
        }
        
        if (this.heightCm !== null) {
            const h = this.heightCm;
            if (h < 75) return Math.max(0, (h - 50) / 25);
            else if (h < 100) return 1 + (h - 75) / 6;
            else if (h < 140) return 4 + (h - 100) / 6;
            else if (h < 160) return 10 + (h - 140) / 5;
            else return Math.min(18, 14 + (h - 160) / 3);
        }
    ...
    validateLimits() {
        ...
        if (this.weightKg !== null) {
            if (this.weightKg > this.limits.weight.max + 10) {
                ...
                const input = this.container.querySelector('#weight-input');
        ...
        if (this.heightCm !== null) {
            if (this.heightCm > this.limits.height.max + 10) {
                ...
                const input = this.container.querySelector('#height-input');
        ...
        if (this.ageYears !== null) {
            if (this.ageYears > this.limits.age.max + 2) {
                ...
                const input = this.container.querySelector('#age-input');
        ...
        const warningEl = this.container.querySelector('#limits-warning');
        if (warningEl) {
    ...
    setupEventListeners() {
        ...
        this._inputHandler = (e) => {
            ...
            if (!target.matches('.pediatric-field')) return;

            const weightInput = this.container.querySelector('#weight-input');
